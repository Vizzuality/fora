  ...
  return (
    <input
      ...
      className={classNames(
        'ring-navy-200 m-0.5 h-4 w-4 flex-shrink-0 rounded ring-offset-1 focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-offset-0 active:ring-2 disabled:ring-0 disabled:ring-offset-0',
