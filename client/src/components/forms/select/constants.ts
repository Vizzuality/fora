export const THEME = {
  dark: {
    ...
    item: {
      base: 'flex items-center justify-between px-6 py-3 text-left text-white transition duration-150 ease-out rounded-sm cursor-pointer focus:bg-blue-0 outline-0 min-h-4',
  ...
  light: {
    ...
    item: {
      base: 'flex items-center justify-between px-6 py-3 text-left text-grey-0 transition duration-150 ease-out rounded-sm cursor-pointer focus:bg-blue-0 outline-0 min-h-4',
      disabled: 'text-sm opacity-50 pointer-events-none',
    },
  },
};
